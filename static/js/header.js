...
document.head.appendChild(style);
    ...
    const closeCategoriesBtn = document.getElementById('closeCategoriesMenu');
    const categoriesOverlay = document.getElementById('categoriesOverlay');

    // Debug logging
    console.log('Hamburger Menu Debug:');
    console.log('categoriesMenuToggle:', categoriesMenuToggle);
    console.log('categoriesSidebar:', categoriesSidebar);
    console.log('closeCategoriesBtn:', closeCategoriesBtn);
    console.log('categoriesOverlay:', categoriesOverlay);

    if (categoriesMenuToggle && categoriesSidebar) {
        console.log('Hamburger menu elements found, setting up event listeners...');
        
        // Open categories menu
        categoriesMenuToggle.addEventListener('click', function() {
        ...
        // Close categories menu function
        function closeCategoriesMenu() {
            ...
            const icon = categoriesMenuToggle.querySelector('i');
            if (icon) {
        ...
        if (closeCategoriesBtn) {
            closeCategoriesBtn.addEventListener('click', closeCategoriesMenu);
        }
        ...
        if (!categoriesMenuToggle) console.error('Missing: categoriesMenuToggle');
        if (!categoriesSidebar) console.error('Missing: categoriesSidebar');
    }
